const zhCNExtra = {
  tenantPortal: {
    ...
    tasks: {
      ...
      queueTitle: '当前任务队列',
      queueDescription: '这里展示当前租户下的全部监控任务，你可以直接启动、停用、编辑或删除。',
      stats: {
        enabled: '启用任务',
        running: '运行中',
        keyword: '关键词任务',
    ...
    results: {
      title: '{tenant} 的结果情报台',
      description: 'CatchYu 会把最新扫描结果、推荐记录和价格变化线索集中展示，帮助你更快判断哪些商品值得继续跟进。',
      workspaceTitle: '结果工作区',
      workspaceDescription: '先选择结果集，再通过推荐筛选、黑名单和导出动作把线索筛干净。',
      stats: {
        files: '结果面板',
        items: '当前条目',
        recommended: '推荐条目',
  ...
  accounts: {
    title: '账号池管理',
    description: '集中维护平台账号池，为租户任务提供稳定的登录资源。',
    hero: {
      panelLabel: '资源池定位',
      panelDescription: '账号池只属于管理员端。这里维护登录状态、导入方式和轮换准备度，为租户任务提供稳定底座。',
      cards: {
        total: '账号规模',
        rotation: '轮换准备',
        guide: '导入流程',
    ...
    editDialog: { title: '更新账号：{name}', description: '替换账号池中的登录状态 JSON。' },
